...
# of Active Record to incrementally modify your database, 
# and then regenerate this schema definition.Note that this 
# schema.rb definition is the authoritative source for yourdatabase schema. 
...
ActiveRecord::Schema.define(version: 0) do
  ...
  # These are extensions that must be enabled in orderto support this database
